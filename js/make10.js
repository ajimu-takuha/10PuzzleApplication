...
function make10(nums, target) {
  ...
  for (var i = 0; i < 4; i++) {
    ...
    var v3 = nums_.shift();
    var v4 = nums_.shift();
    patternA[[v1, v2, v3, v4].join(".")] = [v1, v2, v3, v4];
  }
  ...
  for (var i = 0; i < 4; i++) {
    for (var j = 0; j < 3; j++) {
      for (var k = 0; k < 2; k++) {
        ...
        var v4 = nums_[0];
        patternB[[v1, v2, v3, v4].join(".")] = [v1, v2, v3, v4];
      }
    }
  }
  // } else {
  //   patternA[nums.join(".")] = nums;
  //   patternB[nums.join(".")] = nums;
  // }
  var exps = {};
